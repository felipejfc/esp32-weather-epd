...
#ifndef _GxEPD2_583_T8_WS_H_
#define _GxEPD2_583_T8_WS_H_

#include "GxEPD2_EPD.h"

class GxEPD2_583_T8_WS : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    // constructor
    GxEPD2_583_T8_WS(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
